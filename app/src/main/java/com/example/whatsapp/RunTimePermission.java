...
public class RunTimePermission extends Fragment
{
    ...
    public RunTimePermission(Fragment fragment)
    {
    ...
    public void requestPermission(String[] permissions, RunTimePermissionListener runTimePermissionListener)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        {
            ...
            fragment.requestPermissions(arrayPermissions, 10);
        }
        else
        {
...
//                }
    ...
    public void setAlertMessage()
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            adb = new AlertDialog.Builder(fragment.getActivity(), android.R.style.Theme_Material_Light_Dialog_Alert);
        } else {
            adb = new AlertDialog.Builder(fragment.getActivity());
        }

        adb.setTitle(fragment.getResources().getString(R.string.app_name));
        String msg = "<p>Dear User, </p>" +
                ...
                "<p>Go To : Settings >> App > " + fragment.getResources().getString(R.string.app_name) + " Permission : Allow ALL</p>";
        ...
        if (!((Fragment) fragment).getActivity().isFinishing() && msg.length() > 0)
        {
            adb.show();
        }
        else
