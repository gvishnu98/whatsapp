...
import com.example.whatsapp.AudioService;
import com.example.whatsapp.Chats;
                ...
                case "VOICE":
                    ...
                    layoutVoice.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (tmpBtnPlay != null) {
                                tmpBtnPlay.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_baseline_play_arrow_24));
                            }
